...
<table>
    ...
    if(!$result->num_rows) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>".$row["ip"]."</td>"; //CREAMOS UNA CELDA CON EL VALOR DE "i" EN SU INTERIOR, EL NUMERO AL QUE QUEREMOS HALLAR EL FACTORIAL EN ESTA ITERACION
            echo "<td>".$row["fechaHora"]."</td>"; //CREAMOS UNA CELDA CON EL CALCULO DEL FACTORIAL PARA EL VALOR "i"
